...
test_set=GraphDataset('/kaggle/working/sample/data_chung/data_test_ms.npz')
...
net.load_state_dict(torch.load('/kaggle/input/finetuned1/model (1).pt'))
...
np.savez('/kaggle/working/sample/test_result_tpl.npz',rsmi=rsmi_list,test_y=test_y, test_y_pred=test_y_pred)