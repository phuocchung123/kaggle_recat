...
def finetune(args):
    ...
    train_set = GraphDataset('/kaggle/input/tpl-data2/data_train_tpl(2).npz')
    ...
    valid_set = GraphDataset('/kaggle/input/tpl-data2/data_valid_tpl(2).npz')
    ...
    test_set=GraphDataset('/kaggle/input/tpl-data2/data_test_tpl(2).npz')
