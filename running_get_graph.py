...
data=pd.read_csv('/kaggle/working/sample/data_chung/test.csv',index_col=0)
...
filename_train='/kaggle/working/sample/data_chung/data_train_nonreagent.npz'
...
filename_valid='/kaggle/working/sample/data_chung/data_valid_nonreagent.npz'
...
filename_test='/kaggle/working/sample/data_chung/data_test_nonreagent.npz'
